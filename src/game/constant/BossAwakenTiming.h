...
namespace game::constant::boss_awaken
{
	/**
	 * @brief ボス覚醒演出のタイムライン（秒）
	 *
	 * 演出を出す BossAwakenEffectSystem と、その間ボスを停止（ロック）させる
	 * BossAISystem の両方で共有する。各フェーズの時間をここで定義し、
	...
	// 演出全体の長さ。BossAISystemのフェーズ移行ロック時間と一致する
